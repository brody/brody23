---
title: Forms
description: Forms are one of the core patterns of the web, and enable the interactivity that users expect from a web application.
...
<LinkCard
  type="Source"
  url="https://www.uxmatters.com/mt/archives/2010/06/the-question-protocol-how-to-make-sure-every-form-field-is-necessary.php"
  title="The Question Protocol: How to Make Sure Every Form Field Is Necessary"
  domain="uxmatters.com"
/>
